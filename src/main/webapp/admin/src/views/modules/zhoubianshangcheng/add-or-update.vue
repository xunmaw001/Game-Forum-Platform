  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.youxileixing" label="游戏类型" prop="youxileixing">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangpinguige" label="商品规格" prop="shangpinguige">
              <el-input v-model="ruleForm.shangpinguige" 
                placeholder="商品规格" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="商品图片" prop="shangpintupian">
          <file-upload
          tip="点击上传商品图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.price" label="价格" prop="price">
              <el-input v-model="ruleForm.price" 
