          ...
          <el-form-item class="input" v-if="ruleForm.youximingcheng" label="游戏名称" prop="youximingcheng">
              <el-input v-model="ruleForm.youximingcheng" 
                placeholder="游戏名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="游戏厂商" prop="youxichangshang">
          <el-select v-model="ruleForm.youxichangshang" placeholder="请选择游戏厂商">
            <el-option
                v-for="(item,index) in youxichangshangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
